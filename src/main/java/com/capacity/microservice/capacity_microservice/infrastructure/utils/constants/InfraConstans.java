package com.capacity.microservice.capacity_microservice.infrastructure.utils.constants;

public class InfraConstans {
    public static final String CAPACITY_PATH = "api/v1/capacity";
    public static final String TECHNOLOGY_SERVICE = "technology-service";
